...
{
  if (val < 0) return 0;
  else if (val > 255) return 255; // Bodmer add else to speed up clipping
...
static void* ICACHE_FLASH_ATTR alloc_pool ( /* Pointer to allocated memory block (NULL:no memory available) */
...
static JRESULT ICACHE_FLASH_ATTR create_qt_tbl (  /* 0:OK, !0:Failed */
  JDEC* jd,       /* Pointer to the decompressor object */
...
static JRESULT ICACHE_FLASH_ATTR create_huffman_tbl ( /* 0:OK, !0:Failed */
  JDEC* jd,         /* Pointer to the decompressor object */
...
static int ICACHE_FLASH_ATTR bitext ( /* >=0: extracted data, <0: error code */
  JDEC* jd,   /* Pointer to the decompressor object */
...
static int ICACHE_FLASH_ATTR huffext (  /* >=0: decoded data, <0: error code */
  JDEC* jd,       /* Pointer to the decompressor object */
...
static void ICACHE_FLASH_ATTR block_idct (
...
static JRESULT ICACHE_FLASH_ATTR mcu_load (
  JDEC* jd    /* Pointer to the decompressor object */
)
{
...
static JRESULT ICACHE_FLASH_ATTR mcu_output (
  JDEC* jd,   /* Pointer to the decompressor object */
...
static JRESULT ICACHE_FLASH_ATTR restart (
  JDEC* jd,   /* Pointer to the decompressor object */
...
JRESULT ICACHE_FLASH_ATTR jd_prepare (
  ...
  unsigned int (*infunc)(JDEC*, uint8_t*, unsigned int),  /* JPEG stream input function */
